    ...
    return (
        <div>
            ...
            <nav className='flex flex-row h-16 bg-gray-900 text-gray-200 justify-center items-center'>
                ...
                <Link href="/charts/ethereum" className='max-sm:mx-2 max-md:mx-5 max-lg:mx-10 mx-20 px-3 py-2 rounded-xl hover:bg-gray-700 hover:text-red-500'>Ethereum</Link>
                <Link href="/charts/lumens" className='max-sm:mx-2 max-md:mx-5 max-lg:mx-10 mx-20 px-3 py-2 rounded-xl hover:bg-gray-700 hover:text-red-500'>Lumens</Link>
                <Link href="/charts/cardano" className='max-sm:mx-2 max-md:mx-5 max-lg:mx-10 mx-20 px-3 py-2 rounded-xl hover:bg-gray-700 hover:text-red-500'>Cardano</Link>
            </nav>
